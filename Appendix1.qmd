...
The ACS asks respondents about their primary means of transportation to work through a variable *tranwork.*^[\[1\]](#_ftn1)^ We use this variable as the proxy to indicate whether respondents have actually worked from home by creating *did_WFH* by recoding all forms of transportation as 0 and responses where an individual worked from home as 1.   
...
[\[1\]](#_ftnref1) According to IPUMS ACS, *tranwork* reports a respondent's primary means of transportation to work on the most recent day worked or over the course of the previous week. See Appendix 3 for the question design.
