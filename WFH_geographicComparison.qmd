...
ggsave("./paper_figures/A2-Figure4.png", limitsize = FALSE, width = 8, height = 4, units = "in")
ggsave("./paper_figures/A2-Figure4.eps", limitsize = FALSE, width = 8, height = 4, units = "in")
```
...
ggsave("./paper_figures/A2-Figure3.png", limitsize = FALSE, width = 8, height = 4, units = "in")
ggsave("./paper_figures/A2-Figure3.eps", limitsize = FALSE, width = 8, height = 4, units = "in")
```
...
#| fig-cap: "Percent of Workers that Could Feasibily Work From Home in 2021"
table <- svytable(~YEAR+CanWorkFromHome+occ_2dig_labels_d, design = dstrata) 
...
ggsave("./paper_figures/Figure7.eps", limitsize = FALSE,width = 7, height = 5, units = "in")
ggsave("./paper_figures/Figure7.png", limitsize = FALSE, width = 7, height = 5, units = "in")

ggsave("./paper_figures/A1-Figure3.eps", limitsize = FALSE,width = 7, height = 5, units = "in")
ggsave("./paper_figures/A1-Figure3.png", limitsize = FALSE, width = 7, height = 5, units = "in")
```
...
mapPUMAboth %>% 
  pivot_wider(id_cols = -c(n), names_from ="YEAR", values_from = "Prop") %>%
  mutate(pct_change = `2021`-`2019`) %>%
  ggplot(aes(fill = pct_change*100)) +
  geom_sf(aes(geometry = geometry), color = "black") + 
  theme_void()+
   scale_fill_steps2(low ="red4", mid= "white", high = "forestgreen", 
                       n.breaks = 7,
...
```{r export-figure8, include = FALSE}
mapPUMAboth %>%
  filter(CIHISPEED == 10) %>%
  ggplot(aes(fill = Prop)) +
  geom_sf(aes(geometry = geometry), color = "black")+ 
...
ggsave("./paper_figures/Figure8-map.png", limitsize = FALSE, width = 5, height = 4, units = "in")

ggsave("./paper_figures/Figure8-map.eps", limitsize = FALSE, width = 5, height = 4, units = "in")
```
...
ggsave("./paper_figures/Figure8-dotplot.png", limitsize = FALSE, width = 5, height = 4, units = "in")

ggsave("./paper_figures/Figure8-dotplot.eps", limitsize = FALSE,width = 5, height = 4, units = "in")
...
```{r export-figure4-map, include=FALSE, eval=FALSE}
mapPUMAboth %>% 
  pivot_wider(id_cols = -c(n), names_from ="YEAR", values_from = "Prop") %>%
  mutate(pct_change = `2021`-`2019`) %>%
  ggplot(aes(fill = pct_change*100)) +
...
ggsave("./paper_figures/Figure4-map.eps", limitsize = FALSE, width = 4, height = 5, units = "in")
ggsave("./paper_figures/Figure4-map.png", limitsize = FALSE, width = 4, height = 5, units = "in")
```
...
```{r export-figure4-dotplot, include=FALSE, eval=FALSE}
...
ggsave("./paper_figures/Figure4-dotplot.eps", limitsize = FALSE,width = 8, height = 5, units = "in")
ggsave("./paper_figures/Figure4-dotplot.png", limitsize = FALSE, width = 8, height = 5, units = "in")
```
