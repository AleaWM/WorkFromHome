...
export_summs(m1_2019, m1_2021, 
             model.names = c("2019 Binom", "2021 Binom"), 
            robust = "HC3", statistics = c(N = "nobs", R2 = "r.squared", adjR2 = "adj.r.squared"))
...
m2_2019 <- svyglm(did_wfh~ INCEARN + race_cat+ SEX+ CIHISPEED+CINETHH + occ_2dig_labels+CanWorkFromHome+county_pop_type, design = dstrata2019)
m2_2021 <- svyglm(did_wfh~ INCEARN + race_cat+ SEX+ CIHISPEED+CINETHH + occ_2dig_labels+CanWorkFromHome+county_pop_type, design = dstrata2021)

export_summs(m2_2019, m2_2021, 
...
m4_2019 <- svyglm(did_wfh~NCHLT5+factor(SEX) +factor(MARST)+factor(CINETHH) + occ_2dig_labels+county_pop_type, family = "binomial", design = dstrata2019 )# %>% summary()

m4_2021 <- svyglm(did_wfh~NCHLT5+factor(SEX) +factor(MARST)+factor(CINETHH) + occ_2dig_labels+county_pop_type, family = "binomial", design = dstrata2021)# %>% summary()

export_summs(m4_2019, m4_2021, 
             model.names = c("M4 2019 Logit", "M4 2021 Logit"), 
            robust = "HC3", statistics = c(N = "nobs", R2 = "r.squared", adjR2 = "adj.r.squared"))
