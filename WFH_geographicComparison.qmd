...
ggsave("A2-Figure1.png", limitsize = FALSE,width = 8, height = 4, units = "in")

ggsave("A2-Figure1.eps", limitsize = FALSE,width = 8, height = 4, units = "in")
...
ggsave("A2-Figure2.png", limitsize = FALSE,width = 8, height = 4, units = "in")

ggsave("A2-Figure2.eps", limitsize = FALSE,width = 8, height = 4, units = "in")
```
