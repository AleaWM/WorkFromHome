...
\_\_\_\_ observations have occupations that indicate that they could Work from home

\_\_\_\_ responses have occupations indicating that they can not work from home

\_\_\_\_\_ might be able to work from home.
...
dataset_names <- list('DN_All Matched OCC Codes' = all_occs,
                      'DN_5 Broadest OCC Groups' = occ_5cat, 
                      'DN_OCC 2-digit Groups'= occs_23cat
                      )

write.xlsx(dataset_names, file = 'WFH_feasibility_comparison_D&Ncodesonly.xlsx')
```
